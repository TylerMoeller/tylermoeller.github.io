...
function buildRepoGrid() {
  $.getJSON('https://tylermoeller.github.io/repos.json').done((data) => {
    data.repoList.forEach((repo) => {
      ...
      $('#repo-row').append(`${'<div class="col-sm-6 col-md-4 repo-item">' +
...
function init() {
  ...
  // smooth scrolling
  $('.page-scroll a').click(smoothScroll);
  ...
  if (!$('.fa-twitter').is(':visible')) {
    ...
    $('#adblock-message').html('** <a href="https://www.linkedin.com/in/tylermoeller/">LinkedIn</a> and ' +
